...
const ACTION_CONFIG: Record<AuditAction, { icon: any; color: string; bg: string }> = {
  ...
  create_prospect: { icon: UserPlus, color: 'text-purple-600', bg: 'bg-purple-50' },
  update_prospect: { icon: UserPlus, color: 'text-slate-600', bg: 'bg-slate-100' },
  move_prospect_stage: { icon: ArrowRightLeft, color: 'text-purple-600', bg: 'bg-purple-50' },
