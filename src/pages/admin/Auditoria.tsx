...
const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  create_prospect: 'Criar prospect',
  update_prospect: 'Editar prospect',
  move_prospect_stage: 'Mover etapa do prospect',
  ...
  approve_client: 'Aprovar cadastro',
  return_client: 'Devolver cadastro',
  reject_client: 'Reprovar cadastro',
  ...
  update_production_payment:    'Fechamento corrigido',
